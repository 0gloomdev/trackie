        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Text(poll.question, style: AppTypography.cardTitle),
              ),
              Container(
          ...
          ...poll.options.map(
            (option) => Padding(
              ...
              child: _PollOptionRow(
                ...
                isActive: poll.isActive && !poll.isExpired,
              ),
            ),
          ),
...
class _PollOptionRow extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      onTap: isActive
          ? () {
              ref.read(pollsProvider.notifier).vote(pollId, option.id);
            }
          : null,
      child: Container(
        decoration: BoxDecoration(
              ...
              Align(
                ...
                child: FractionallySizedBox(
                  ...
                  child: Container(
                    height: 40,
                    decoration: BoxDecoration(
                      color: AppColors.secondary.withAlpha(isActive ? 77 : 26),
                    ),
                  ),
                ),
              ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      post.userName ?? 'Voyager',
                      style: AppTypography.cardTitle,
                    ),
                    Text(
                      post.type.replaceAll('_', ' ').toUpperCase(),
                      style: AppTypography.typeBadge.copyWith(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            '${DateTime.now().difference(c.timestamp).inHours}h ago',
                            style: AppTypography.caption,
                          ),
                        ],
                      ),
