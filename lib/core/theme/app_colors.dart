...
class AppColors {
  ...
  // Primary palette
  static const Color darkPrimary = Color(0xFFB79FFF);
  static const Color darkPrimaryDim = Color(0xFFA88CFB);
  static const Color darkPrimaryContainer = Color(0xFFAB8FFE);
  static const Color darkOnPrimary = Color(0xFF361083);
  static const Color darkOnPrimaryFixed = Color(0xFF000000);
  static const Color darkOnPrimaryFixedVariant = Color(0xFF330B80);
  static const Color darkOnPrimaryContainer = Color(0xFF290070);
  static const Color darkPrimaryFixed = Color(0xFFAB8FFE);
  static const Color darkPrimaryFixedDim = Color(0xFF9D81F0);

  // Secondary palette
  static const Color darkSecondary = Color(0xFF62FAE3);
  static const Color darkSecondaryDim = Color(0xFF50EBD5);
  static const Color darkSecondaryContainer = Color(0xFF006B5F);
  static const Color darkOnSecondary = Color(0xFF005C52);
  static const Color darkOnSecondaryContainer = Color(0xFFDCFFF7);
  static const Color darkSecondaryFixed = Color(0xFF62FAE3);
  static const Color darkSecondaryFixedDim = Color(0xFF50EBD5);
  static const Color darkOnSecondaryFixed = Color(0xFF004840);
  static const Color darkOnSecondaryFixedVariant = Color(0xFF00675C);

  // Tertiary palette
  static const Color darkTertiary = Color(0xFFFF86C3);
  static const Color darkTertiaryDim = Color(0xFFF271B5);
  static const Color darkTertiaryContainer = Color(0xFFF673B7);
  static const Color darkOnTertiary = Color(0xFF5F003E);
  static const Color darkOnTertiaryContainer = Color(0xFF4A002F);
  static const Color darkTertiaryFixed = Color(0xFFFF8BC5);
  static const Color darkTertiaryFixedDim = Color(0xFFF976BA);
  static const Color darkOnTertiaryFixed = Color(0xFF360021);
  static const Color darkOnTertiaryFixedVariant = Color(0xFF73004B);
  ...
  static Color get glassBorderLight => const Color(0x14000000);
  static Color get glassHighlightLight => const Color(0x1A000000);
  ...
  static Color get glassSurfaceDark =>
      darkSurfaceContainer.withValues(alpha: 0.4);
  static Color get glassBorder => darkOutlineVariant;
}
